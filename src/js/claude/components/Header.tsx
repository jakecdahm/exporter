...
interface HeaderProps {
  ...
  onExportTypeChange: (value: "clips" | "sequences" | "markers") => void;
}
...
const Header: React.FC<HeaderProps> = ({ onRefresh, onHistoryClick, onSettingsClick, exportType, onExportTypeChange }) => {
  return (
    <header className="header">
      <div className="header-left">
        ...
        <div className="header-toggle">
          <button
            className={`header-toggle-btn ${exportType === "clips" ? "active" : ""}`}
            onClick={() => onExportTypeChange("clips")}
          >
            Clip
          </button>
          <button
            className={`header-toggle-btn ${exportType === "sequences" ? "active" : ""}`}
            onClick={() => onExportTypeChange("sequences")}
          >
            Sequence
          </button>
          <button
            className={`header-toggle-btn ${exportType === "markers" ? "active" : ""}`}
            onClick={() => onExportTypeChange("markers")}
          >
            Markers
          </button>
        </div>
      ...
      <div className="header-right">
        ...
        <button className="icon-button" onClick={onHistoryClick} title="Export history">
          <HistoryIcon />
        </button>
